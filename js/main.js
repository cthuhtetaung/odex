            ...
            if (slides.length >= 6) {
                if (currentLang === 'en') {
                    ...
                    if (slides[4]) {
                        ...
                        if (desc) desc.textContent = 'Season Hotel is a top hospitality business, efficiently managing guest services, inventory, and HR with OdeX ERP.';
                    ...
                    if (slides[4]) {
                        ...
                        if (desc) desc.textContent = 'Season Hotel သည် ဧည့်ဝန်ဆောင်မှုလုပ်ငန်းတွင် ထိပ်တန်းဟိုတယ်တစ်ခုဖြစ်ပြီး OdeX ERP ဖြင့် ဧည့်သည်စီမံခန့်ခွဲမှု၊ စာရင်းနှင့် HR ကို ထိရောက်စွာ လုပ်ဆောင်သည်။';
